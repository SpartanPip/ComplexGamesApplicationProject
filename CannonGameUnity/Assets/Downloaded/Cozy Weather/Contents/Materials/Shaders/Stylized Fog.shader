...
Shader "Distant Lands/Cozy/Stylized Fog"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Alpha = saturate( ( ( 1.0 - saturate( ( ( ( ( float3( 0,0,0 ) - _WorldSpaceCameraPos ).y * 0.1 ) * ( 1.0 / _FogSmoothness ) ) + ( 1.0 - _FogOffset ) ) ) ) * _FogIntensity ) );
		}
...
ASEEND*/
//CHKSM=55B2998E0F65F27BFBF392B10FA8A24B1CF91800